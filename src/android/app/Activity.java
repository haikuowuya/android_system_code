	...
	Window.Callback, KeyEvent.Callback, OnCreateContextMenuListener, ComponentCallbacks2
{
	...
	/**
	 * Creates a newActionBar, locates the inflated ActionBarView,
	...
	private void initActionBar()
	{
		...
		window.getDecorView();// 如果DecorView为空的话， 实例化
	...
	public boolean onKeyDown(int keyCode, KeyEvent event)
	{
		...
		else
		{
			...
			{
				handled = TextKeyListener.getInstance().onKeyDown(null, mDefaultKeySsb, keyCode,
					event);
	...
	public void startActivityAsUser(Intent intent, Bundle options, UserHandle user)
	{
		...
		Instrumentation.ActivityResult ar = mInstrumentation.execStartActivity(this,
			mMainThread.getApplicationThread(), mToken, this, intent, -1, options, user);
		if (ar != null)
		{
			mMainThread.sendActivityResult(mToken, mEmbeddedID, -1, ar.getResultCode(),
				ar.getResultData());
		}
	}
		...
		throws IntentSender.SendIntentException
	{
		if (mParent == null)
		{
			startIntentSenderForResultInner(intent, requestCode, fillInIntent, flagsMask,
				flagsValues, this, options);
		}
	...
	private void startIntentSenderForResultInner(IntentSender intent, int requestCode,
		Intent fillInIntent, int flagsMask, int flagsValues, Activity activity, Bundle options)
		throws IntentSender.SendIntentException
	{
		try
		{
		...
		int flagsValues, int extraFlags, Bundle options) throws IntentSender.SendIntentException
	{
		if (options != null)
		{
			startIntentSenderForResult(intent, -1, fillInIntent, flagsMask, flagsValues,
				extraFlags, options);
		}
		else
		{
		...
		if (mParent == null)
		{
			...
			try
			{
				...
				result = ActivityManagerNative.getDefault().startActivity(
					...
					requestCode, ActivityManager.START_FLAG_ONLY_IF_NEEDED, null, null, options);
			}
			catch (RemoteException e)
			{
				// Empty
		...
		Bundle options)
	{
		...
		if (ar != null)
		{
			mMainThread.sendActivityResult(mToken, child.mEmbeddedID, requestCode,
				ar.getResultCode(), ar.getResultData());
		}
	}
	...
	{
		Instrumentation.ActivityResult ar = mInstrumentation.execStartActivity(this,
			mMainThread.getApplicationThread(), mToken, fragment, intent, requestCode, options);
		if (ar != null)
		{
	...
	public void overridePendingTransition(int enterAnim, int exitAnim)
	{
		try
		{
			ActivityManagerNative.getDefault().overridePendingTransition(mToken, getPackageName(),
				enterAnim, exitAnim);
		}
		catch (RemoteException e)
		{}
	...
	public void finish()
	{
		if (mParent == null)
		{
			...
			try
			{
				...
				if (ActivityManagerNative.getDefault().finishActivity(mToken, resultCode,
					resultData))
				{
					mFinished = true;
				}
	...
	public void finishActivity(int requestCode)
	{
		if (mParent == null)
		{
			try
			{
				ActivityManagerNative.getDefault().finishSubActivity(mToken, mEmbeddedID,
					requestCode);
			}
			catch (RemoteException e)
			{
	...
	public void finishActivityFromChild(Activity child, int requestCode)
	{
		try
		{
			ActivityManagerNative.getDefault().finishSubActivity(mToken, child.mEmbeddedID,
				requestCode);
		}
		catch (RemoteException e)
		{
	...
	public PendingIntent createPendingResult(int requestCode, Intent data, int flags)
	{
		...
		try
		{
			...
			IIntentSender target = ActivityManagerNative.getDefault().getIntentSender(
				...
				new Intent[] { data }, null, flags, null, UserHandle.myUserId());
	...
	public void setRequestedOrientation(int requestedOrientation)
	{
		if (mParent == null)
		{
			try
			{
				ActivityManagerNative.getDefault().setRequestedOrientation(mToken,
	...
	public View onCreateView(View parent, String name, Context context, AttributeSet attrs)
	{
		...
		if (FragmentManagerImpl.DEBUG)
			Log.v(TAG, "onCreateView: id=0x" + Integer.toHexString(id) + " fname=" + fname
				+ " existing=" + fragment);
		if (fragment == null)
		{
	...
	public boolean shouldUpRecreateTask(Intent targetIntent)
	{
		try
		{
			...
			return !ActivityManagerNative.getDefault().targetTaskAffinityMatchesActivity(mToken,
				info.taskAffinity);
		}
		catch (RemoteException e)
		{
	...
	public Intent getParentActivityIntent()
	{
		...
		try
		{
			...
			final Intent parentIntent = parentActivity == null ? Intent.makeMainActivity(target)
	...
	{
		if (false)
			Log.v(TAG, "Dispatching result: who=" + who + ", reqCode=" + requestCode + ", resCode="
