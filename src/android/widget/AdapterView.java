 ...
 * <p>
 * See {@link ListView}, {@link GridView}, {@link Spinner} and {@link Gallery} for commonly used subclasses of AdapterView. <div class="special reference">
 * <h3>Developer Guides</h3>
 * <p>
 * For more information about using AdapterView, read the <a href="{@docRoot}guide/topics/ui/binding.html">Binding to Data with AdapterView</a> developer guide.
 * </p>
 * </div>
 */
public abstract class AdapterView<T extends Adapter> extends ViewGroup
{
	...
	/**
	 * Extra menu information provided to the {@link android.view.View.OnCreateContextMenuListener#onCreateContextMenu(ContextMenu, View, ContextMenuInfo) } callback when a context menu is brought up for this AdapterView.
	 */
	...
	/**
	 * @return The number of items owned by the Adapter associated with this AdapterView. (This is the number of data items, which may be larger than the number of visible views.)
	 */
	@ViewDebug.CapturedViewProperty
	public int getCount()
	{
	 ...
	 * @return the position within the adapter's data set of the view, or {@link #INVALID_POSITION} if the view does not correspond to a list item (or it is not currently visible).
	 */
	 ...
	 * @return The next selectable position starting at position and then searching either up or down. Returns {@link #INVALID_POSITION} if nothing can be found.
	 */
