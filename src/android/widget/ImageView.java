...
public class ImageView extends View
{
	...
	/**
	 * An optional argument to supply a maximum width for this view. Only valid if {@link #setAdjustViewBounds(boolean)} has been set to true. To set an image to be a maximum
	 * of 100 x 100 while preserving the original aspect ratio, do the following: 1) set
	 * adjustViewBounds to true 2) set maxWidth and maxHeight to 100 3) set the height and width
	 * layout params to WRAP_CONTENT.
	 * <p>
	 * Note that this view could be still smaller than 100 x 100 using this approach if the original image is small. To set an image to a fixed size, specify that size in the layout params and then use {@link #setScaleType(android.widget.ImageView.ScaleType)} to determine how to fit the image within
	 * the bounds.
	 * </p>
	 * 
	 * @param maxWidth
	...
	/**
	 * An optional argument to supply a maximum height for this view. Only valid if {@link #setAdjustViewBounds(boolean)} has been set to true. To set an image to be a
	...
	{
		/**
		 * Scale using the image matrix when drawing. The image matrix can be set using {@link ImageView#setImageMatrix(Matrix)}. From XML, use this syntax: <code>android:scaleType="matrix"</code>.
		 */
		MATRIX(0),
		/**
		 ...
		 * From XML, use this syntax: <code>android:scaleType="fitCenter"</code>.
		 */
		FIT_CENTER(3),
		/**
