...
public final class ViewRoot233 extends Handler implements ViewParent,
    ...
    public ViewRoot233(Context context) {
        super();
    ...
    */
    ...
    static class InputMethodCallback extends IInputMethodCallback.Stub {
        private WeakReference<ViewRoot233> mViewRoot;

        public InputMethodCallback(ViewRoot233 viewRoot) {
            mViewRoot = new WeakReference<ViewRoot233>(viewRoot);
        }

        public void finishedEvent(int seq, boolean handled) {
            final ViewRoot233 viewRoot = mViewRoot.get();
            if (viewRoot != null) {
    ...
    static class W extends IWindow.Stub {
        private final WeakReference<ViewRoot233> mViewRoot;

        public W(ViewRoot233 viewRoot, Context context) {
            mViewRoot = new WeakReference<ViewRoot233>(viewRoot);
        }
