...
public class ActionBarView extends AbsActionBarView
{
	 ...
	 */
	private static final int DISPLAY_RELAYOUT_MASK = ActionBar.DISPLAY_SHOW_HOME | ActionBar.DISPLAY_USE_LOGO | ActionBar.DISPLAY_HOME_AS_UP | ActionBar.DISPLAY_SHOW_CUSTOM | ActionBar.DISPLAY_SHOW_TITLE;
	...
	protected void onLayout(boolean changed, int l, int t, int r, int b)
	{
		...
		// In LTR mode, we start from left padding and go to the right; in RTL
		// mode, we start
