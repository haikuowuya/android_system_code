 ...
 * Original file: E:\\android_workspace2\\system_code\\src\\android\\view\\IWindow.aidl
 */
...
@Override public void resized(android.graphics.Rect frame, android.graphics.Rect contentInsets, android.graphics.Rect visibleInsets, boolean reportDraw, android.content.res.Configuration newConfig) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
try {
_data.writeInterfaceToken(DESCRIPTOR);
...
public void resized(android.graphics.Rect frame, android.graphics.Rect contentInsets, android.graphics.Rect visibleInsets, boolean reportDraw, android.content.res.Configuration newConfig) throws android.os.RemoteException;
