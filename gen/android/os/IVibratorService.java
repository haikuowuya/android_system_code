 ...
 * Original file: E:\\android_workspace2\\system_code\\src\\android\\os\\IVibratorService.aidl
 */
package android.os;
/** {@hide} */
...
@Override public void vibrate(long milliseconds, android.os.IBinder token) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
...
@Override public void vibratePattern(long[] pattern, int repeat, android.os.IBinder token) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
