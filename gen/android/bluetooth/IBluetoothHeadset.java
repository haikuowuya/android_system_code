 ...
 * Original file: E:\\android_workspace2\\system_code\\src\\android\\bluetooth\\IBluetoothHeadset.aidl
 */
...
@Override public void roamChanged(boolean roam) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
...
static final int TRANSACTION_getAudioState = (android.os.IBinder.FIRST_CALL_TRANSACTION + 13);
static final int TRANSACTION_isAudioOn = (android.os.IBinder.FIRST_CALL_TRANSACTION + 14);
static final int TRANSACTION_connectAudio = (android.os.IBinder.FIRST_CALL_TRANSACTION + 15);
static final int TRANSACTION_disconnectAudio = (android.os.IBinder.FIRST_CALL_TRANSACTION + 16);
static final int TRANSACTION_startScoUsingVirtualVoiceCall = (android.os.IBinder.FIRST_CALL_TRANSACTION + 17);
static final int TRANSACTION_stopScoUsingVirtualVoiceCall = (android.os.IBinder.FIRST_CALL_TRANSACTION + 18);
static final int TRANSACTION_phoneStateChanged = (android.os.IBinder.FIRST_CALL_TRANSACTION + 19);
static final int TRANSACTION_roamChanged = (android.os.IBinder.FIRST_CALL_TRANSACTION + 20);
...
public void roamChanged(boolean roam) throws android.os.RemoteException;
