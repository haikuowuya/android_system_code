 ...
 * Original file: E:\\android_workspace2\\system_code\\src\\android\\content\\pm\\IPackageManager.aidl
 */
...
/**
     ...
     * returned.
     */
@Override public android.content.pm.ParceledListSlice getInstalledPackages(int flags, java.lang.String lastRead, int userId) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
...
/**
     ...
     * returned.
     */
@Override public android.content.pm.ParceledListSlice getInstalledApplications(int flags, java.lang.String lastRead, int userId) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
android.content.pm.ParceledListSlice _result;
...
/**
     ...
     */
@Override public void deletePackage(java.lang.String packageName, android.content.pm.IPackageDeleteObserver observer, int flags) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
...
/**
     ...
     */
@Override public void setApplicationEnabledSetting(java.lang.String packageName, int newState, int flags, int userId) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
...
@Override public int installExistingPackage(java.lang.String packageName) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
int _result;
...
_data.writeInterfaceToken(DESCRIPTOR);
_data.writeString(packageName);
mRemote.transact(Stub.TRANSACTION_installExistingPackage, _data, _reply, 0);
_reply.readException();
_result = _reply.readInt();
}
finally {
...
static final int TRANSACTION_installPackageWithVerificationAndEncryption = (android.os.IBinder.FIRST_CALL_TRANSACTION + 78);
static final int TRANSACTION_installExistingPackage = (android.os.IBinder.FIRST_CALL_TRANSACTION + 79);
static final int TRANSACTION_verifyPendingInstall = (android.os.IBinder.FIRST_CALL_TRANSACTION + 80);
static final int TRANSACTION_extendVerificationTimeout = (android.os.IBinder.FIRST_CALL_TRANSACTION + 81);
...
static final int TRANSACTION_setPermissionEnforced = (android.os.IBinder.FIRST_CALL_TRANSACTION + 84);
static final int TRANSACTION_isPermissionEnforced = (android.os.IBinder.FIRST_CALL_TRANSACTION + 85);
static final int TRANSACTION_isStorageLow = (android.os.IBinder.FIRST_CALL_TRANSACTION + 86);
}
...
/**
     ...
     * returned.
     */
public android.content.pm.ParceledListSlice getInstalledPackages(int flags, java.lang.String lastRead, int userId) throws android.os.RemoteException;
/**
     * This implements getInstalledApplications via a "last returned row"
     * mechanism that is not exposed in the API. This is to get around the IPC
     * limit that kicks in when flags are included that bloat up the data
...
public int installExistingPackage(java.lang.String packageName) throws android.os.RemoteException;
