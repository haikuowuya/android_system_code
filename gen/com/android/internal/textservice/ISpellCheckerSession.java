 ...
 * Original file: E:\\android_workspace2\\system_code\\src\\com\\android\\internal\\textservice\\ISpellCheckerSession.aidl
 */
...
_data.writeTypedArray(textInfos, 0);
_data.writeInt(suggestionsLimit);
mRemote.transact(Stub.TRANSACTION_onGetSentenceSuggestionsMultiple, _data, _reply, 0);
_reply.readException();
}
finally {
_reply.recycle();
